        ...
        header: options.poster.showHeader ? (
            <div key="header" className="flex items-start justify-between mb-8">
                <div className="flex gap-0">
                    <div className="w-8 h-2" style={{ backgroundColor: rectangleColors[0] }}></div>
                    <div className="w-8 h-2" style={{ backgroundColor: rectangleColors[1] }}></div>
                    <div className="w-8 h-2" style={{ backgroundColor: rectangleColors[2] }}></div>
                </div>
