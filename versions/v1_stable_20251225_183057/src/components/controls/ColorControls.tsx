    ...
    const handleThemeChange = (theme: 'light' | 'dark') => {
        ...
        onOptionsChange({
            ...
            poster: {
                ...
                textColor: isDark ? '#F3F3F3' : '#1A1A1A',
                titleColor: isDark ? '#F3F3F3' : '#1A1A1A',
                subtitleColor: isDark ? '#F3F3F3' : '#1A1A1A',
                directorTextColor: isDark ? '#999999' : '#666666',
                listColor: isDark ? '#F3F3F3' : '#1A1A1A',
                descriptionColor: isDark ? '#F3F3F3' : '#1A1A1A',
                yearColor: isDark ? '#F3F3F3' : '#1A1A1A',
            }
        });
    };
